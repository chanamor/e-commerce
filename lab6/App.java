...
public class App{
    ...
    public static void main(String[] args) {
        ...
        ShoppingCart cart = new ShoppingCart(catalog, pricingService);
        ...
        System.out.println("Caught expected error (non-existent product): " + e.getMessage());
    }
        ...
        System.out.println("Caught expected error (invalid quantity): " + e.getMessage());
    }   
